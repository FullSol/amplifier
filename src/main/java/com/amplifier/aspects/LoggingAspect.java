...
public class LoggingAspect {
    ...
    @Before(value = "execution(* com.amplifier.*.*.*(..))")
    ...
    // com.amplifier.services.UserServiceImpl.getAllUserShows(..))")
    @After(value = "execution(* com.amplifier.*.*.*(..))")
