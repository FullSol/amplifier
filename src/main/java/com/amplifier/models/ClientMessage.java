...
public class ClientMessage {
    ...
    @ApiModelProperty(name = "message", notes = "a String value that contains the contents of any HTTP response the provided given HTTP verb", required = true, value = "TEST_MESSAGE")
