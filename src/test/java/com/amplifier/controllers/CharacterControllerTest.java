...
public class CharacterControllerTest {
  ...
  Character wizard = new Character(1, "wiz", "wizRealm");
  Character barbarian = new Character(2, "barb", "barbRealm");
  Character necromancer = new Character(3, "necro", "necroRealm");
  Character crusader = new Character(4, "crusName", "crusRealm");
  Character monk = new Character(5, "monkName", "monkRealm");
  ...
  public void addNewCharacter() throws Exception {
    ...
    .post("/character")
    .content(asJsonString(new Character(6, "Witch Doctor", "doctorRealm")))
