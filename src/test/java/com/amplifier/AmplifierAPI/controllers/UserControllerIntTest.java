package com.amplifier.AmplifierAPI.controllers;
...
import com.amplifier.controllers.UserController;
...
public class UserControllerIntTest {
        ...
        static void setUpBeforeClass() {
                mockUser1 = new User(1, "L3viathan", "L3viathan@gmail.com", "password", "Levi", "Choi",
                                LocalDate.now());
                mockUser2 = new User(2, "FullSol", "FullSol@gmail.com", "password", "Calvin", "Raines",
                                LocalDate.now());
                mockUser3 = new User(3, "jularmerme", "jularmerme@gmail.com", "password", "Julian", "Mercado",
                                LocalDate.now());

                mockUserCreation = new User(4, "pyaeger", "pyaeger@gmail.com", "password", "Patrick", "Yaeger",
                                LocalDate.now());

                mockUserModification = new User(5, "briiitelord", "briiitelord@gmail.com", "password", "Joachim",
                                "Ogodi",
                                LocalDate.now());
